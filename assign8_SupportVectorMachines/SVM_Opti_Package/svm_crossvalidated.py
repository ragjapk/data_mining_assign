...
def plot_data_with_labels(X_train,y_train,X_test,y_test,best_c):
    ...
    accuracy,sol,support_vectors,f,bias,alphas,pred= svm(X_train,y_train,X_p,y_test,best_c)
...
def getdata():
    ...
    accuracy,sol,support_vectors,f,bias,alphas,pred=svm(X_train,y_train,X_test,y_test,best_c)
    #print(sol['gap'],sol['pcost'],sol['dcost'])
    print(sol['gap'])
    print(sol['primal objective'])
    print(sol['dual objective'])
    print(sol['primal slack'])
    #print(sol['snl'])
    print(accuracy)
    print(best_c)
